...
public class ActivityReportCategory extends AppCompatActivity {
    ...
    //method to prepare data for insertion
                    ...
                    if (incomeExpense.getCheckedRadioButtonId() == R.id.IncomeRadioBtn)
                        {
                            ...
                            {
                                TotalIncome = TotalIncome + dataAllIncome.get(i).getAmount();
                        ...
                        {
                            TotalExpense = TotalExpense+ dataAllExpense.get(i).getAmount();
        ...
        private void displayPieChart()
        {
            ...
            categorySplitValuesExpense.put("Other", (float) (Other/TotalExpense)*100);
            categorySplitValuesExpense.put("Food", (float) (Food/TotalExpense)*100);
            categorySplitValuesExpense.put("Entertainment", (float) (Entertainment/TotalExpense)*100);
            categorySplitValuesExpense.put("Healthcare", (float) (Healthcare/TotalExpense)*100);
            categorySplitValuesExpense.put("Utilities", (float) (Utilities/TotalExpense)*100);
            categorySplitValuesExpense.put("Travel", (float) (Travel/TotalExpense)*100);
            categorySplitValuesExpense.put("Household", (float) (Household/TotalExpense)*100);
            categorySplitValuesExpense.put("Personal", (float) (Personal/TotalExpense)*100);

            categorySplitValuesIncome.put("Other", (float) (Other/TotalIncome)*100);
            categorySplitValuesIncome.put("PayCheck", (float) (PayCheck/TotalIncome)*100);
            categorySplitValuesIncome.put("Business", (float) (Business/TotalIncome)*100);
